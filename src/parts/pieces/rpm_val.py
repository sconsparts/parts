...
headers = [
    ...
    dict(key='Recommends', extra_keys=('X_RPM_RECOMMENDS',), value_mapper=rpm_list_mapper, value='{key}: {value}\n',),
    dict(key='Supplements', extra_keys=('X_RPM_SUPPLEMENTS',), value_mapper=rpm_list_mapper, value='{key}: {value}\n',),
    dict(key='Suggests', extra_keys=('X_RPM_SUGGESTS',), value_mapper=rpm_list_mapper, value='{key}: {value}\n',),
    dict(key='Enhances', extra_keys=('X_RPM_ENHANCES',), value_mapper=rpm_list_mapper, value='{key}: {value}\n',),
