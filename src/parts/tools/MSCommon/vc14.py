...
msvc.Register(
    ...
    info=[
        ToolInfo(
            ...
            install_scanner=[
                RegFinder([
                    r'Software\Wow6432Node\Microsoft\VisualStudio\14.0\Setup\VC\ProductDir',
                    r'Software\Microsoft\VisualStudio\14.0\Setup\VC\ProductDir',
                    r'Software\Wow6432Node\Microsoft\VCExpress\14.0\Setup\VC\ProductDir',
                    r'Software\Microsoft\VCExpress\14.0\Setup\VC\ProductDir'
                ]),
                EnvFinder([
                    'VS140COMNTOOLS'
                ], '../../VC'),
