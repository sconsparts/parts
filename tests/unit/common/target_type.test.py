...
class TestParseTarget(unittest.TestCase):
    ...
    def test_parse_concept_as_implied_name5(self):
        ...
        self.assertEqual(tmp, { '_section': 'build', '_recursive': False, '_name': 'name', '_properties': {'k3': 'hello', 'k': 'v', 'k1': ['1', '2', '3', '4']}})
    ...
    def test_parse_concept_as_implied_name6(self):
        ...
        self.assertEqual(tmp, { '_section': 'build', '_recursive': False, '_name': 'alias', '_properties': {'k3': 'hello', 'k': 'v', 'k1': ['1', '2', '3', '4']}})
    ...
    def test_parse_name_properties1(self):
        ...
        self.assertEqual(tmp, {'_concept': 'utest', '_section': 'utest', '_recursive': True, '_name': 'c', '_properties': {'k3': 'hello', 'k': 'v', 'k1': ['1', '2', '3', '4']}})

    def test_parse_name_properties2(self):
        '''Testing parsing of utest::name::c@k:v@k1:1,2,3,4@k3:hello'''
        tmp=target_type._parse_target("utest::name::c@k:v@k1:1,2,3,4@k3:hello")
        self.assertEqual(tmp, {'_concept': 'utest', '_section': 'utest', '_recursive': False, '_name': 'c', '_properties': {'k3': 'hello', 'k': 'v', 'k1': ['1', '2', '3', '4']}})
    ...
    def test_parse_name_properties3(self):
        ...
        self.assertEqual(tmp, {'_section': 'build', '_recursive': True, '_name': 'c', '_properties': {'k3': 'hello', 'k': 'v', 'k1': ['1', '2', '3', '4']}})

    def test_parse_name_properties4(self):
        '''Testing parsing of name::c@k:v@k1:1,2,3,4@k3:hello'''
        tmp=target_type._parse_target("name::c@k:v@k1:1,2,3,4@k3:hello")
        self.assertEqual(tmp, {'_section': 'build', '_recursive': False, '_name': 'c', '_properties': {'k3': 'hello', 'k': 'v', 'k1': ['1', '2', '3', '4']}})
    ...
    def test_parse_name_properties7(self):
        ...
        self.assertEqual(tmp, {'_section': 'build', '_recursive': True, '_name': 'c', '_groups': ['a1', 'a2', 'b3'], '_properties': {'k3': 'hello', 'k': 'v', 'k1': ['1', '2', '3', '4']}})

    def test_parse_name_properties8(self):
        '''Testing parsing of c@k:v@k1:1,2,3,4@k3:hello::a1,a2,b3'''
        tmp=target_type._parse_target("c@k:v@k1:1,2,3,4@k3:hello::a1,a2,b3")
        self.assertEqual(tmp, {'_section': 'build', '_recursive': False, '_name': 'c', '_groups': ['a1', 'a2', 'b3'], '_properties': {'k3': 'hello', 'k': 'v', 'k1': ['1', '2', '3', '4']}})
